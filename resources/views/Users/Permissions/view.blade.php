                            ...
                            <div id="permissions_table_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <p>
                                            <a href="{{ route('permissions.create') }}" class="btn btn-success">Add New
                                                Permission</a>
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <table id="permissions_table"
                                            ...
                                            <tr role="row">
                                                <th class="sorting_asc  text-bold bg-primary" tabindex="0"
                                                    aria-controls="permissions_table" rowspan="1" colspan="1">ID
                                                </th>
                                                <th class="sorting  text-bold bg-primary" tabindex="0"
                                                    aria-controls="permissions_table" rowspan="1" colspan="1">Name
                                                </th>
                                                <th class="sorting  text-bold bg-primary" tabindex="0"
                                                    aria-controls="permissions_table" rowspan="1" colspan="1">Guard Name
                                                </th>
                                                <th class="sorting  text-bold bg-primary" tabindex="0"
                                                    aria-controls="permissions_table" rowspan="1" colspan="1">Creation
                                                    Date Time
                                                </th>
                                                <th class="sorting  text-bold bg-primary" tabindex="0"
                                                    aria-controls="permissions_table" rowspan="1" colspan="1">Updation
                                                    Date Time
                                                </th>
                                                <th class="sorting  text-bold bg-primary" tabindex="0"
                                                    aria-controls="permissions_table" rowspan="1" colspan="1">Actions
                                                </th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        @if($r->deleted_at==null)
                                                            ...
                                                            <form action="{{ route('permissions.destroy',$r->id) }}"
                                                                  method="post">
                                                                @method('DELETE')
                                                        ...
                                                        @else
                                                            ...
                                                            <form action="/permissions/restore/{{$r->id}}"
                                                                  method="post">
                                                                @method('PUT')
                                                                <input type="hidden" name="_token"
                                                                       value="{{ csrf_token() }}">
