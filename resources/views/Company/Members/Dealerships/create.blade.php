    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Create New Dealership</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Create New Dealership Form</h3>
            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('dealerships.store') }}">
                    @csrf
                ...
                $('#society').change(function (){
                    $.ajax({
                        ...
                        success: function (data){
                            $('#memberprofile').empty();
                            $('#memberprofile').append('<option value="">Choose Member Profile</option>');
