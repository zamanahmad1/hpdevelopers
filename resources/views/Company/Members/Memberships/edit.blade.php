    ...
    <div class="content-wrapper">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Edit Membership Form</h3>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="society_code" id="society" class="form-control">
                                    ...
                                    @foreach($society as $s)
                                        <option value="{{$s->code}}" @if($s->code==$memberShip->society_code) selected @endif>{{$s->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="memberprofile" id="memberprofile" class="form-control">
                                    <option value="" name="memberprofile">Select Member Profile</option>
                                        <option value="{{$memberShip->memberprofile_code}}" selected>{{$memberProfile->name}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="5">{{$memberShip->description}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
