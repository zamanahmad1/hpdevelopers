    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Plot {{$plotInventory->id}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Edit Plot {{$plotInventory->id}} Form</h3>
            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('plotinventories.update',$plotInventory->id) }}">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="area" id="area" class="form-control"
                                       placeholder="enter only numeric value" value="{{$plotInventory->area}}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="street" id="street" class="form-control">
                                    ...
                                    @foreach($street as $s)
                                        <option value="{{$s->code}}"
                                                @if($plotInventory->street_code==$s->code)
                                                    selected
                                                @endif
                                        >{{$s->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select name="size" id="size" class="form-control">
                                    ...
                                    @foreach($plotSize as $ps)
                                        <option value="{{$ps->code}}"
                                                @if($plotInventory->plotsize_code==$ps->code)
                                                    selected
                                                @endif
                                        >{{$ps->name}}</option>
                                    @endforeach
                                ...
                                <select name="category" id="category" class="form-control">
                                    ...
                                    @foreach($plotCategory as $pc)
                                        <option value="{{$pc->code}}"
                                                @if($plotInventory->plotcategory_code==$pc->code)
                                                    selected
                                                @endif
                                        >{{$pc->name}}</option>
                                    @endforeach
                                ...
                                <select name="type" id="type" class="form-control">
                                    ...
                                    @foreach($plotType as $pt)
                                        <option value="{{$pt->code}}"
                                                @if($plotInventory->plottype_code==$pt->code)
                                                    selected
                                                @endif
                                        >{{$pt->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    @foreach($plotStatus as $ps)
                                        <option value="{{$ps->code}}"
                                                @if($plotInventory->plotstatus_code==$ps->code)
                                                    selected
                                                @endif
                                        >{{$ps->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select name="shape" id="shape" class="form-control">
                                    ...
                                    @foreach($plotShape as $ps)
                                        <option value="{{$ps->code}}"
                                                @if($plotInventory->shape_code==$ps->code)
                                                    selected
                                                @endif
                                        >{{$ps->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <select name="availability" id="availability" class="form-control">
                                    ...
                                    @foreach($plotAvailability as $pa)
                                        <option value="{{$pa->code}}"
                                                @if($plotInventory->plotavailability_code==$pa->code)
                                                    selected
                                                @endif
                                        >{{$pa->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                @foreach($plotInhensiveFeature as $pif)
                                    <div class="custom-control custom-checkbox pl-5">
                                        <input class="custom-control-input" name="inhensiveFeature[]" type="checkbox"
                                               id="{{$pif->id}}" value="{{$pif->code}}"
                                                @foreach($temp as $t)
                                                    @if($t==$pif->code)
                                                        checked
                                                    @endif
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="5">{{$plotInventory->description}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
