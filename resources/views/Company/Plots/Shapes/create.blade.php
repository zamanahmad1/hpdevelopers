    ...
    <div class="content-wrapper">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Create New Plot Shape Form</h3>
            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('plotshapes.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- text input -->
