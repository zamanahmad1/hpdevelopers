                            ...
                            <div class="form-group">
                                ...
                                <select name="society_code" id="society" class="form-control">
                                    ...
                                    @foreach($society as $s)
                                        <option value="{{$s->code}}" @if($sector->society_code==$s->code) selected @endif>{{$s->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="5">{{$sector->description}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
