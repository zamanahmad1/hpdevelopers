    ...
    <div class="content-wrapper">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Create New Installment Plan Form</h3>
            </div>

            <div class="card-body">
                <form method="POST" action="{{ route('installmentplans.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- text input -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label>Booking</label>
                                <input type="number" name="booking" id="booking" class="form-control" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="allocation" id="allocation" class="form-control" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="confirmation" id="confirmation" class="form-control" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="months" id="months" class="form-control" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="quarterly_installment" id="quarterly_installment" class="form-control" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="monthly_installment" id="monthly_installment" class="form-control" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="midyear_installment" id="midyear_installment" class="form-control" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="yearly_installment" id="yearly_installment" class="form-control" step="0.01">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="possession" id="possession" class="form-control" step="0.01">
                            </div>
                        </div>
