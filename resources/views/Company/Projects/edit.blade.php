    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Project {{$project->id}}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Edit Project {{$project->id}} Form</h3>
            </div>
                ...
                <form method="POST" action="{{ route('projects.update',$project->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Code</label>
                                <input type="text" name="code" class="form-control" id="code" value="{{$project->code}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
